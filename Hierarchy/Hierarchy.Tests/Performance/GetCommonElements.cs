namespace Hierarchy.Tests.Performance
{
    ...
    public class GetCommonElements
    {
        ...
        public void PerformanceGetCommonElements_WithHalfCommonElementsInBothCollections()
        {
            ...
            var commonElements = hierarchy.GetCommonElements(hierarchy2).ToArray();

            CollectionAssert.AreEqual(common, commonElements, "GetCommonElements method returned incorrect collection!");
